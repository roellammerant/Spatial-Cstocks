...
png(
  "output_plot/MainFigure_ImportanceITV.jpg",
  width = 12,
  height = 18,
  units = 'in',
  res = 900
...
legend("topright", legend = c("Species turnover", "Intraspecific variation", "Covariation", "Total variation"), 
       ...
       pch = 15, bty = "n", pt.cex = 3, cex = 2.4,  horiz = F)
